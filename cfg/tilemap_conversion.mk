...
$(eval $(call TMX2DATA, SET_FOLDER      , src/tilemap/      ))
$(eval $(call TMX2DATA, SET_OUTPUTS     , hs bin      ))

$(eval $(call TMX2DATA, CONVERT, assets/intro.tmx, intro ))

$(eval $(call TMX2DATA, CONVERT, assets/level1.tmx, level1 ))
$(eval $(call TMX2DATA, CONVERT, assets/level2.tmx, level2 ))
$(eval $(call TMX2DATA, CONVERT, assets/level3.tmx, level3 ))

$(eval $(call TMX2DATA, CONVERT, assets/level4.tmx, level4 ))
$(eval $(call TMX2DATA, CONVERT, assets/level5.tmx, level5 ))
$(eval $(call TMX2DATA, CONVERT, assets/level6.tmx, level6 ))
