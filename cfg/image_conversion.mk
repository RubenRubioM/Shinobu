...
$(eval $(call IMG2SP, CONVERT, assets/final.png, 8, 16, ninja_sp, ninja_pal))
$(eval $(call IMG2SP, CONVERT, assets/shuriken.png, 4, 4, shuriken_sp))
$(eval $(call IMG2SP, CONVERT, assets/enemigos.png, 8, 16, enemigos_sp))

$(eval $(call IMG2SP, SET_IMG_FORMAT  , zgtiles            ))
$(eval $(call IMG2SP, SET_OUTPUT      , bin                  ))
$(eval $(call IMG2SP, CONVERT         , assets/tiles.png , 8, 8, tiles))
$(eval $(call IMG2SP, CONVERT         , assets/tiles2.png , 8, 8, tiles2))
